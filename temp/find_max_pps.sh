...
do
  ...
  # Start the sniffer (packat_sniffer.py) in the background
  sudo python /home/ruchitjagodara/Education/computer_networks/packat_sniffer.py <<EOF > /tmp/sniffer_log.txt 2>&1 &
$INTERFACE_VETH1
$SNIFFER_DURATION
EOF
